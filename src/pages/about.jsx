    ...
    >
      <Grid.Col>
        ...
        <Text tag="p" variant="paragraph1" textAlign="justify">
          ...
          uma pós-graduação em gestão (MBA) de banco de dados Oracle 🎓. Além de
          diversos cursos e auto estudo. Fora da informática gosto de estudos
          sociais e ambientais. Astronomia é outro algo que me diverte também.
        ...
        <Text tag="p" variant="paragraph1" textAlign="justify">
          ...
          diversos scripts e aplicações em shell scripts. Entre um tempo e outro
          livre dentro do trabalho, tive oportunidade de desenvolver uma
          ...
          informação. Aqui passei na admministração da infra de sistemas Linux e
          JBoss (Java). Atualmente atuo como DBA. Meu forte conhecimento de
          shell script me permitiu desenvolver projetos para clonagens de bancos
          de dados, verificações de disponibilidades e integração de aplicações.
          Ainda tive o prazer de desenvolver um projeto de uma aplicação web em
          PHP e Javascript. A acrescentar, tenho um bom raciocínio lógico o que
          acredito ser de grande valia no meu dia a dia. Além de gostar bastante
          do meu trabalho sou bem focado em desempenhá-lo da melhor maneira
          possível.
        </Text>
        <Text tag="p" variant="subTitle">
        ...
        <Text tag="ul" variant="paragraph1" textAlign="justify">
          ...
          <li>
            ...
            aplicações abertas (open source), pois acredito que a colaboração de
            todos cria uma sociedade mais justa
          </li>
          <li>
